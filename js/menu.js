...
document.write ("<div class='top'>");
    ...
    document.write ("<div class='date'>");
        ...
        document.write ("<a href='https://www.getmonero.org/'target='_blank'><div class='adv1'><img src='images/monero-logo.png' width='300' height='85' alt='门罗币' title='Home | Monero - secure, private, untraceable' /></a>");
    document.write ("</div>");
document.write ("</div>");
document.write ("<div class='clear'></div>");
<!-- 头部（logo + 日期） end -->
